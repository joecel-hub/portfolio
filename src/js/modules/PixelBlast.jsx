...
function createTouchTexture() {
  ...
  function drawPoint(p) {
    ...
    else intensity = -p.age * (p.age - 2) || 0
    intensity *= p.force
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      if (liquidEffect) {
        ...
        const tu = liq.uniforms.get('uTime')
    ...
    threeRef.current = { renderer, scene, camera, material, clock, uniforms, ro, raf, composer, touch, liquidEffect }
